...
<>
<div class="mb-0" style={{backgroundColor:'#eaeaea', width:'100%',margin:'0',padding:'0'}}>
  <section class="">




    <div class="mb-0 px-6 py-12 lg:my-12 md:px-12 text-gray-800 text-center lg:text-left">
      <div class="container mx-auto xl:px-32">
        <div class="grid lg:grid-cols-2 gap-12 flex items-center">
          <div class="mt-12 lg:mt-0">
            <h1 class="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">Lower your  <br /><span class="text-blue-600">IT Costs with Kubernetes</span></h1>
