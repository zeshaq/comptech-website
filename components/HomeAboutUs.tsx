  ...
  <section className="mb-32 text-gray-800 text-center">
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 lg:gap-x-0 items-center">
      <div className="mb-12 lg:mb-0 relative">
        ...
        <h5 className="text-lg font-medium text-blue-600 font-bold mb-4">40+</h5>
        <h6 className="font-medium text-gray-500">Years in Operation</h6>
      ...
      <div className="mb-12 lg:mb-0 relative">
        ...
        <h5 className="text-lg font-medium text-blue-600 font-bold mb-4">200+</h5>
        <h6 className="font-medium text-gray-500">Successful Project Completions</h6>
        <hr className="absolute right-0 top-0 w-px bg-gray-200 h-full hidden lg:block" />
      </div>
      ...
      <div className="mb-12 md:mb-0 relative">
        ...
        <h5 className="text-lg font-medium text-blue-600 font-bold mb-4">100+</h5>
        <h6 className="font-medium text-gray-500">Engineers & Consultants</h6>
        <hr className="absolute right-0 top-0 w-px bg-gray-200 h-full hidden lg:block" />
      </div>
      ...
      <div className="relative">
        ...
        <h5 className="text-lg font-medium text-blue-600 font-bold mb-4">8</h5>
        <h6 className="font-medium text-gray-500 mb-0">Presence in countries</h6>
      </div>
    </div>
  </section>
